...
export const demoLibraryTracks: LibraryTrackRecord[] = [
  // Music Library preview tracks (brief 20-09-2026): five ~25s preview cuts
  // of Osman's original compositions, exported from the client's master WAVs
  // (which stay private in the master content folder — only these compressed
  // previews are public). Public titles/genres per the brief's table; no
  // invented moods/use-cases/credits (§21: only confirmed facts).
  {
    id: "trk-blue-hour",
    slug: "blue-hour",
    title: "Blue Hour",
    ...
    useCases: [],
    durationSec: 24,
    audioUrl: "/audio/music-library/blue-hour-preview.mp3",
    description: null,
    status: "PUBLISHED",
    featured: false,
    sortOrder: 1,
  ...
  },
  {
    ...
    useCases: [],
    durationSec: 26,
    audioUrl: "/audio/music-library/prime-time-84-preview.mp3",
    description: null,
    status: "PUBLISHED",
    featured: false,
    sortOrder: 2,
  ...
  {
    id: "trk-orbit-after-dark",
    slug: "orbit-after-dark",
    title: "Orbit After Dark",
    genre: "Electronic / Space Disco",
    moods: [],
    useCases: [],
    durationSec: 25,
    audioUrl: "/audio/music-library/orbit-after-dark-preview.mp3",
    description: null,
    status: "PUBLISHED",
    featured: false,
    sortOrder: 3,
  ...
  },
  {
    ...
    useCases: [],
    durationSec: 26,
    audioUrl: "/audio/music-library/deep-pocket-preview.mp3",
    description: null,
    status: "PUBLISHED",
    featured: false,
    sortOrder: 4,
  ...
  {
    id: "trk-electric-therapy",
    slug: "electric-therapy",
    title: "Electric Therapy",
    genre: "Rock",
    moods: [],
    useCases: [],
    durationSec: 25,
    audioUrl: "/audio/music-library/electric-therapy-preview.mp3",
    description: null,
    status: "PUBLISHED",
    featured: false,
    sortOrder: 5,
...
export const realEvents: EventRecord[] = [
  ...
  {
    // OSMAN_NEW_SHOWS brief (24-09-2026): four supplied shows, entered
    // exactly as given. Titles follow the EXISTING approved Bierfabriek
    // convention ("Osman Meyredi – live at Bierfabriek", per the
    // 10-09 event) as §3 directs; the venue link is the one already
    // approved for this venue. No free-entry claim is copied over — no invented times, links or entry claims
    // (eventType OTHER + no ticketingType → no CTA is rendered).
    // NOTE for Aditya: the brief says "Friday 4 November 2026" but
    // 04-11-2026 is a Wednesday — date entered as supplied; confirm.
    id: "evt-bierfabriek-2026-10-02",
    slug: "bierfabriek-2026-10-02",
    eventType: "OTHER",
    title: "Osman Meyredi – live at Bierfabriek",
    description: "",
    date: "2026-10-02",
  ...
  {
    id: "evt-bierfabriek-2026-11-04",
    slug: "bierfabriek-2026-11-04",
    eventType: "OTHER",
    title: "Osman Meyredi – live at Bierfabriek",
    description: "",
    date: "2026-11-04",
  ...
  {
    // Title exactly as supplied ("Zoku Amsterdam \u2014 Rooftop Event" is
    // the client's own wording, em dash included). No time supplied — none
    // invented.
    id: "evt-zoku-rooftop-2026-11-06",
    slug: "zoku-amsterdam-rooftop-2026-11-06",
    eventType: "OTHER",
    title: "Zoku Amsterdam — Rooftop Event",
    description: "",
    date: "2026-11-06",
    startTime: "",
    endTime: null,
    venue: "Zoku Amsterdam",
  ...
  {
    id: "evt-bierfabriek-2026-11-13",
    slug: "bierfabriek-2026-11-13",
    eventType: "OTHER",
    title: "Osman Meyredi – live at Bierfabriek",
    description: "",
    date: "2026-11-13",
